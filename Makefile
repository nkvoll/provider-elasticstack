...
PROJECT_REPO ?= github.com/elastic/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-elasticstack_v$(TERRAFORM_PROVIDER_VERSION)_x5
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/elasticstacks/01-delete.yaml.tmpl.
