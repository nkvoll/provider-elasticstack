...
spec:
  package: elastic/provider-elasticstack:v0.1.0
EOF
```

Notice that in this example Provider resource is referencing ControllerConfig with debug enabled.

You can see the API reference [here](https://doc.crds.dev/github.com/elastic/provider-elasticstack).
...
open an [issue](https://github.com/elastic/provider-elasticstack/issues).
